...
public class ListUtils {
    ...
    /**
     * addUpgradeServer distinct entry to list
     * 
     * @param <V>
     * @param sourceList
     * @param entry
     * @return if entry already exist in sourceList, return false, else addUpgradeServer it and return true.
     */
    ...
    /**
     * addUpgradeServer all distinct entry to list1 from list2
     * 
     * @param <V>
     * @param sourceList
     * @param entryList
    ...
    /**
     * addUpgradeServer not null entry to list
     * 
     * @param sourceList
     * @param value
     * @return <ul>
