...
public class CameraAppUI implements ModeListView.ModeSwitchListener,
    ...
    private boolean areBottomControlsUsed(ModuleController module) {
        if (module.isUsingBottomBar()) {
            showBottomBar();
            hideModeOptions();////LQB--hideModeOptions
            return true;
        } else {
            hideBottomBar();
            hideModeOptions();
    ...
    public void showBottomBar() {
        mBottomBar.setVisibility(View.VISIBLE);//LQB
    }
    ...
    public void setIndicatorBottomBarWrapperVisible(boolean visible) {
        mIndicatorBottomBarWrapper.setVisibility(View.GONE/*visible ? View.VISIBLE : View.INVISIBLE*/);//ADD BY LQB
    }
    ...
    public void setBottomBarVisible(boolean visible) {
        mBottomBar.setVisibility(View.GONE /*? View.VISIBLE : View.INVISIBLE*/);//ADD BY LQB
    }
